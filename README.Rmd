...
- Agreement metrics: Bland–Altman (two-method `bland_altman()` and repeated-measures `bland_altman_repeated()`), and Lin’s concordance correlation coefficient (pairwise `ccc_pairwise_u_stat()` and repeated-measures LMM/REML `ccc_lmm_reml()`)
