...
(`cia()`) for replicated long-format method-comparison data, with subject-level
pairwise estimation and balanced-replication overall estimation, Lin's
concordance correlation coefficient (including repeated-measures LMM/REML
extensions), and intraclass correlation for both wide and repeated-measures
designs.
